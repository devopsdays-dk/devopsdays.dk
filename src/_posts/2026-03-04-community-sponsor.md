...
header:
  teaser: /assets/images/posts/community/devops-community.png
tags:
  - Sponsor
...
> _"Unless you are already EXACTLY where you want to be in regards of Platform Engineering, utilization of Agentic AI in software development, Infrastructure as Code, DevX, shift-left mindset and Continuous Delivery, then becoming an engaged member of the DevOps community of practice is probably the best knowledge investment you could make for your team."_

The DevOpsDays is a yearly recurring two-days conference. We have been in Denmark since 2018. The conference is famous for being _engaging_.

We run an _**unconference**_ format with short, sharp speaks (only 30 mins) and Ignite talks (5 minutes pitches) all carefully curated with the purpose of creating disturbance, insights and raising eye-brows aas well as discussions and we only do bums-on-seats until lunch. After lunch we break out in Open Space discussions, Lean Coffee discussions, workshops - and just plain _mingle_.
...
Show the World that you take DevOps serious. It both attracts talent and it makes you team members proud. Supporting this community is like drinking distilled good **DevOps Karma**
{: .kicker}
